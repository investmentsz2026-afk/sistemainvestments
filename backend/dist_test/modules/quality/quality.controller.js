...
let QualityController = class QualityController {
    ...
    async processItem(req, itemId, data) {
...
], QualityController.prototype, "getPendingItems", null);
__decorate([
    (0, common_1.Get)('processed'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], QualityController.prototype, "getProcessedItems", null);
__decorate([
    (0, common_1.Post)('acknowledge/:itemId'),
    __param(0, (0, common_1.Param)('itemId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], QualityController.prototype, "acknowledgeItem", null);
__decorate([
    (0, common_1.Post)('process/:itemId'),
    ...
    __metadata("design:returntype", Promise)
], QualityController.prototype, "processItem", null);
